...
import com.HanifNurIlhamSanjayaJBusBR.LoginActivity;
...
public class ManageBusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myBusListView = this.findViewById(R.id.manageBusListView);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.manage_bus_action_bar, menu);
        return true;
    }
